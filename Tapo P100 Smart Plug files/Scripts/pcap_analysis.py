...
# For installation and more on https://scapy.readthedocs.io/en/latest/installation.html
...
def parse_pcap(file_path):
    ...
    return unique_ips, connections, dns_queries

def display_connections(unique_ips, connections, dns_queries):
    print(f"Unique IPs in the PCAP")
...
if __name__ == "__main__":
    ...
    unique_ips, connections, dns_queries = parse_pcap(pcap_file)
    display_connections(unique_ips, connections, dns_queries)
